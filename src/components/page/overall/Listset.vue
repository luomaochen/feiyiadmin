    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i> 列表设置</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="radio-box">
                <span> 热门项目 </span>
                <el-radio v-model="radio" label="1">自动展示</el-radio>
                <el-radio v-model="radio" label="2">手动展示</el-radio>
        </div>
        <div class="container">
        ...
        <div class="radio-box">
            <span> 最新项目 </span>
            <el-radio v-model="radio1" label="1">自动展示</el-radio>
            <el-radio v-model="radio1" label="2">手动展示</el-radio>
        </div>
        <div class="container">
            <el-table :data="tableData1" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column prop="number" label="序号" sortable width="80" ></el-table-column>
        ...
        <div class="radio-box">
            <span> 项目图片</span>
            <el-radio v-model="radio2" label="1">自动展示</el-radio>
            <el-radio v-model="radio2" label="2">手动展示</el-radio>
        </div>
        <div class="container">
            <el-table :data="tableData1" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column prop="number" label="序号" sortable width="80" ></el-table-column>
        ...
        <div class="radio-box">
            <span> 项目视频</span>
            <el-radio v-model="radio3" label="1">自动展示</el-radio>
            <el-radio v-model="radio3" label="2">手动展示</el-radio>
        </div>
        <div class="container">
            <el-table :data="tableData1" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column prop="number" label="序号" sortable width="80" ></el-table-column>
